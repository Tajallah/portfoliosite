    ...
    return (
      <div className="App">
          ...
          <div className="Content-Box">
            ...
            around 17 and I love cats... I'm honestly not that interesting. 
            I'm a vegetarian from the LA area area who hates talking about 
            themself and loves learning new things. Also I'm a sagittarius.<br></br><br></br>
            ...
            around a Linux box and am no strnager to automating "the boring 
            stuff".<br></br><br></br>I have a passion for data science and 
            analytics and tend to spend more time than I should reading 
            ml-related papers. One day I'll get around to using 
            Kaggle as more than just place to bum datasets haha...<br></br>
